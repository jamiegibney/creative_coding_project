...
impl TwoPoleResonator {
    ...
    pub fn magnitude_response_at(&self, frequency_hz: f64) -> f64 {
        ...
        let p1 = 1.0 + a1 * wt.cos() + a2 * wt2.cos();
        let p2 = -a1 * wt.sin() - a2 * wt2.sin();
        let den = p1.hypot(p2);
    ...
    pub fn phase_response_at(&self, frequency_hz: f64) -> f64 {
        ...
        let num = -a1 * wt.sin() - a2 * wt2.sin();
        let den = 1.0 + a1 * wt.cos() + a2 * wt2.cos();
...
impl Filter for TwoPoleResonator {
    fn process(&mut self, sample: f64) -> f64 {
        ...
        let output = (self.z2 * -a2) + (self.z1 * -a1) + (sample * b0);
